...
DEFAULT_GSM8K_AUG_TRAIN="${DEFAULT_GSM8K_AUG_TRAIN:-$DATA_DIR/zen-E__GSM8k-Aug/gsm8k_aug_train.json}"
DEFAULT_GSM8K_AUG_TEST="${DEFAULT_GSM8K_AUG_TEST:-$DATA_DIR/zen-E__GSM8k-Aug/gsm8k_test.json}"
DEFAULT_GSM8K_AUG_NL_TRAIN="${DEFAULT_GSM8K_AUG_NL_TRAIN:-$DATA_DIR/zen-E__GSM8k-Aug-NL/gsm8k_aug_nl.json}"
